...
*/
export default function Dial(_ref) {
  var color = _ref.color,
    name = _ref.name,
    value = _ref.value,
    increment = _ref.increment,
    decrement = _ref.decrement;
  return /*#__PURE__*/React.createElement(Wrapper, null, /*#__PURE__*/React.createElement(DialButton, {
    color: color,
    ariaLabel: "Increment ".concat(name),
    onClick: increment
  }, /*#__PURE__*/React.createElement(ChevronUpSVG, null)), /*#__PURE__*/React.createElement(Value, {
    "data-testid": "".concat(name, "-value")
  }, value), /*#__PURE__*/React.createElement(DialButton, {
    color: color,
    ariaLabel: "Decrement ".concat(name),
    onClick: decrement
  }, /*#__PURE__*/React.createElement(ChevronDownSVG, null)));
}
Dial.propTypes = {
